...
(function() {
  ...
  describe('inherits() tests', function() {
    ...
    describe('constructor and prototype tests', function() {
      ...
      it('should copy properties from prototype param.', function() {
        return Circle.prototype.should.include.keys('area');
      });
      it('should do the same if called without prototype param.', function() {
        function A() {};
        inherits(A, Point);
        A.prototype.__proto__.should.equal(Point.prototype);
        A.prototype.constructor.should.equal(A);
        return A.prototype._base.should.equal(Point);
      });
      return it('should keep constructor\'s name', function() {
        function A() {};
        inherits(A, Point);
...
//# sourceMappingURL=1.inherits.tests.map
